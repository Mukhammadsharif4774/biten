...
import BTenCartItemComponent from '../components/BTenCartItemComponent';
    ...
    <View style={styles.container}>
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <BTenCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
      ...
      {cart.length ? (
        <View style={styles.summaryContainer}>
          ...
          <Text style={styles.sum}>{totalPrice}.00 $</Text>
        </View>
      ) : (
        ''
      )}
